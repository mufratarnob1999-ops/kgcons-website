/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 8213558023fcfbf70cd538df0cc2fcd9)
// Runtime types generated with workerd@1.20260828.1 2026-08-31 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	ADMIN_EMAIL: "mufrat@kgcons.org";
	NEXTJS_ENV: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_EMAIL" | "NEXTJS_ENV" | "RESEND_API_KEY" | "ANTHROPIC_API_KEY">> {}
}
